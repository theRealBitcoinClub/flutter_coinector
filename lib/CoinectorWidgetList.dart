...
*/
  ...
  void _updateDistanceToAllMerchantsIfNotDoneYet() {
    try {
      print("\n_updateDistanceToAllMerchantsIfNotDoneYet 1\n");
            ...
            if (userPosition != null && savedPosition == null)
              {
                _updateDistanceToAllMerchantsNow().then((updateSuccess) {
                  print(
                      "\n_updateDistanceToAllMerchantsIfNotDoneYet updateSuccess1\n");
                  if (updateSuccess) {
                    print(
                        "\n_updateDistanceToAllMerchantsIfNotDoneYet updateSuccess2\n");
