...
FunctionsEmulator.prototype.start = function (shellMode) {
    ...
    try {
        ...
        emulatorConfig.set("projectId", projectId);
    ...
    return functionsConfig
        ...
        return parseTriggers(projectId, functionsDir, {}, firebaseConfig).catch(function (e) {
            utils.logWarning(clc.yellow("functions:") +
        ...
        return Promise.all(_.map(operations, function (operation) {
            if (operation.state === "rejected") {
                utils.logWarning(clc.yellow("functions:") + " Failed to emulate " + _.get(operation, "reason.name", ""));
                return Promise.resolve();
            }
            if (!operation.value) {
                return Promise.resolve();
